...
export const themes: ThemeDef[] = [
  {
    ...
    label: "Work",
    icon: "Building2",
    bgImage: "/themeImage/1.png",
    gradient: "from-brown-400 via-black-400 to-brown-500",
  ...
  // {
  //   id: "dragons",
  //   label: "Dragons & Castles",
  //   icon: "Flame",    
  //   bgImage: "/themeImage/6.png",
